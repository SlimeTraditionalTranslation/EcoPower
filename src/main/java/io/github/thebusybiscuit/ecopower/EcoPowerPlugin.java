...
public class EcoPowerPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemStack categoryItem = new CustomItemStack(SlimefunUtils.getCustomHead("240775c3ad75763613f32f04986881bbe4eee4366d0c57f17f7c7514e2d0a77d"), "&2綠能發電");
        ...
        SteamTurbine simpleTurbine = registerSteamTurbine(itemGroup, "STEAM_TURBINE", "aefd921cb61594324f3c09d7ac7d38185d2734333968f3ac38382cddf15f6d71", "&e簡易蒸氣發電機", MachineTier.MEDIUM, 4, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_INGOT,
                null, SlimefunItems.COPPER_WIRE, null
        });
        
        SteamTurbine advancedTurbine = registerSteamTurbine(itemGroup, "STEAM_TURBINE_2", "161aad79fb748bff1e6e94d4b6a5a277cc961c1a9abfe2a4ed88baab8a2b5971", "&c進階蒸氣發電機", MachineTier.ADVANCED, 6, new ItemStack[] {
                null, rotor, null,
        ...
        registerSteamTurbine(itemGroup, "STEAM_TURBINE_3", "b65e29a67860d82f66afe1060ec8a9ceacc8c7afe108f5d42f52ba854b0a62dc", "&4黑鑽石蒸氣發電機", MachineTier.END_GAME, 13, new ItemStack[] {
                null, rotor, null,
        ...
        WindTurbine simpleWindTurbine = registerWindTurbine(itemGroup, "WIND_TURBINE", "d23e4ce096e00eae6aba10d356b785c3fecc5aa3d7dad4a4a2a27ed7750df981", "&e簡易風力發電機", MachineTier.MEDIUM, 5, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_THRUSTER, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_THRUSTER,
                null, SlimefunItems.COPPER_WIRE, null
        });

        WindTurbine advancedWindTurbine = registerWindTurbine(itemGroup, "WIND_TURBINE_2", "2df9e595dbeac33f43b37dd4ffbc234ea0fa7c3f98aad77dc906ce5d6783c79d", "&c進階風力發電機", MachineTier.ADVANCED, 11, new ItemStack[] {
                null, rotor, null,
        ...
        registerWindTurbine(itemGroup, "WIND_TURBINE_3", "3fcef461b43f06ef9d58c94065bbf41b77a10050520b44082d5f66f6dbe71da0", "&4黑鑽石風力發電機", MachineTier.END_GAME, 23, new ItemStack[] {
        ...
        registerLightningReceptor(itemGroup, "LIGHTNING_RECEPTOR", "&e閃電接收器", 512, 8192, new ItemStack[] {
        ...
        LunarGenerator lunarGenerator = registerLunarGenerator(itemGroup, "LUNAR_GENERATOR", "&5月光發電機", 128, new ItemStack[] {
        ...
        SolarGenerator solarGenerator = registerHighEnergySolarGenerator(itemGroup, "HIGH_ENERGY_SOLAR_GENERATOR", "c4fe135c311f7086edcc5e6dbc4ef4b23f819fddaa42f827dac46e3574de2287", "&9萬能太陽能發電機", 256, new ItemStack[] {
        ...
        registerSolarHelmet(itemGroup, "HIGH_ENERGY_SOLAR_HELMET", "&9萬能太陽能頭盔", 5, new ItemStack[] {
        ...
        registerHighEnergySolarGenerator(itemGroup, "RADIANT_SOLAR_GENERATOR", "240775c3ad75763613f32f04986881bbe4eee4366d0c57f17f7c7514e2d0a77d", "&9輻射太陽能發電機", 512, new ItemStack[] {
    ...
    public String getBugTrackerURL() {
        return "https://github.com/SlimeTraditionalTranslation/EcoPower/issues";
    }
